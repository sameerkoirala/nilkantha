...
{{--                    <div class="card-body">--}}
{{--                        <a href="{{ url('/posts/create/courses') }}" class="btn btn-success btn-sm" title="Add New Post">--}}
...
{{--                                <thead>--}}
{{--                                <tr>--}}
{{--                                    <th>Course</th><th>File</th><th>Actions</th>--}}
{{--                                </tr>--}}
{{--                                </thead>--}}
{{--                                <tbody>--}}
...
{{--                                            <a href="{{ url('/posts/courses/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>--}}
