...
{{--                    <div class="card-body">--}}
{{--                        <a href="{{ url('/posts/create/alumni') }}" class="btn btn-success btn-sm" title="Add New Post">--}}
...
{{--                                <thead>--}}
{{--                                <tr>--}}
{{--                                    <th>Title</th><th>File Path</th><th>Actions</th>--}}
{{--                                </tr>--}}
{{--                                </thead>--}}
{{--                                <tbody>--}}
{{--                                @foreach($posts as $item)--}}
{{--                                    <tr>--}}
{{--                                        <td>{{ $item->title }}</td><td>{{ $item->file_path }}</td>--}}
{{--                                        <td>--}}
...
{{--                                            <a href="{{ url('/posts/alumni/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>--}}
