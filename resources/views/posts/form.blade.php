...
<div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
    ...
    <textarea class="ckeditor form-control" rows="5" name="description" type="textarea" id="description" >{{ isset($post->description) ? $post->description : ''}}</textarea>
...
@if($type === 'events')
    <div class="form-group {{ $errors->has('date') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="date" type="date" id="date" value="{{ isset($post->date) ? $post->date : ''}}" >
...
@if($type === 'events')
    <div class="form-group {{ $errors->has('start_time') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="start_time" type="time" id="start_time" value="{{ isset($post->start_time) ? $post->start_time : ''}}" >
...
@if($type === 'events')
    <div class="form-group {{ $errors->has('end_time') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="end_time" type="time" id="end_time" value="{{ isset($post->end_time) ? $post->end_time : ''}}" >
...
@if($type === 'events')
    <div class="form-group {{ $errors->has('location') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="location" type="text" id="location" value="{{ isset($post->location) ? $post->location : ''}}" >
...
@if($type === 'nccs')
    <div class="form-group {{ $errors->has('video_link') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="video_link" type="text" id="video_link" value="{{ isset($post->video_link) ? $post->video_link : ''}}" >
...
@if($type === 'aboutUs')
    <div class="form-group {{ $errors->has('landing_page') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="landing_page" type="checkbox" id="landing_page" value="1" {{ isset($post->landing_page) ? ( $post->landing_page === '1' ? 'checked' : '') : '' }}>
        {!! $errors->first('sub_title', '<p class="help-block">:message</p>') !!}
    </div>
@endif
