        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/posts/create/galleries') }}" class="btn btn-success btn-sm" title="Add New Post">
                            ...
                            <table class="table">
                                ...
                                @foreach($posts as $item)
                                    <tr>
                                        <td>{{ $item->title }}</td>
                                        <td>
                                            <a href="{{ url('/images/' . $item->id ) }}" title="Add Gallery"><button class="btn btn-info btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Images </button></a>
...
{{--                                            <a href="{{ url('/posts/' . $item->id) }}" title="View Post"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>--}}
                                            <a href="{{ url('/posts/galleries/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
