...
{{--                    <div class="card-body">--}}
{{--                        <a href="{{ url('/posts/create/news') }}" class="btn btn-success btn-sm" title="Add New Post">--}}
...
{{--                                            <a href="{{ url('/posts/news/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>--}}
