...
{{--                    <div class="card-body">--}}
{{--                        <a href="{{ url('/posts/create/nccs') }}" class="btn btn-success btn-sm" title="Add New Post">--}}
...
{{--                                <thead>--}}
{{--                                <tr>--}}
{{--                                    <th>Title</th><th>Sub Title</th><th>Description</th><th>Featured Image</th>--}}
{{--                                    <th>Video Link</th><th>Actions</th>--}}
{{--                                </tr>--}}
{{--                                </thead>--}}
{{--                                <tbody>--}}
...
{{--                                        <td><img src="{{\Illuminate\Support\Facades\URL::asset($item->image_path)}}"></td>--}}
...
{{--                                            <a href="{{ url('/posts/nccs/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>--}}
