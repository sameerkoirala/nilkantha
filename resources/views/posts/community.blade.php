...
{{--                    <div class="card-body">--}}
{{--                        <a href="{{ url('/posts/create/community') }}" class="btn btn-success btn-sm" title="Add New Post">--}}
...
{{--                                <thead>--}}
{{--                                <tr>--}}
{{--                                    <th>Title</th><th>Sub Title</th><th>Description</th><th>Featured Image</th><th>Actions</th>--}}
{{--                                </tr>--}}
{{--                                </thead>--}}
{{--                                <tbody>--}}
...
{{--                                            <a href="{{ url('/images/' . $item->id ) }}" title="Add Gallery"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Gallery</button></a>--}}
{{--                                            <a href="{{ url('/posts/community/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>--}}
