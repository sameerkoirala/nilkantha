        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/posts/create/events') }}" class="btn btn-success btn-sm" title="Add New Post">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th>Title</th><th>Start Time</th><th>End Time</th><th>Date</th>
                                ...
                                @foreach($posts as $item)
                                    <tr>
                                        <td>{{ $item->title }}</td><td>{{ $item->start_time }}</td>
                                        <td>{{ $item->end_time }}</td><td>{{ $item->date }}</td><td>{{ $item->location }}</td>
                                        <td>
                                            <a href="{{ url('/images/' . $item->id ) }}" title="Add Gallery"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Images </button></a>
                                            ...
                                            <a href="{{ url('/posts/events/' . $item->id . '/edit') }}" title="Edit Post"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
