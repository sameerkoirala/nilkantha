...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Facultymembers</div>
                    <div class="card-body">
                        <a href="{{ url('/members/create/') }}" class="btn btn-success btn-sm" title="Add New FacultyMember">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Member Type</th><th>Image</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
...
{{--                                            <a href="{{ url('/member/' . $item->id) }}" title="View Member"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>--}}
                                            <a href="{{ url('/members/' . $item->id . '/edit') }}" title="Edit FacultyMember"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
